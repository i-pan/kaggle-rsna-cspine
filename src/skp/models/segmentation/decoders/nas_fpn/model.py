...
from .decoder import NASFPNDecoder


class NASFPN(SegmentationModel):
    ...
    def __init__(
        ...
        self.decoder = NASFPNDecoder(
            in_channels=self.encoder.out_channels,
            depth=encoder_depth,
            pyramid_channels=decoder_pyramid_channels,
            segmentation_channels=decoder_segmentation_channels,
            stack_times=decoder_stack_times,
        ...
        if self.deep_supervision:
            ...
            self.supervisor_heads.append(
                SegmentationHead(
                    in_channels=decoder_pyramid_channels,
                    out_channels=classes,
                    dropout=dropout,
                    kernel_size=3,
                    upsampling=1,
