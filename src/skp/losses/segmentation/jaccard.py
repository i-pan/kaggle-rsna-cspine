...
class JaccardLoss(_Loss):
    ...
    def forward(self, y_pred: torch.Tensor, y_true: torch.Tensor) -> torch.Tensor:
        ...
        """
        Original:
        # IoU loss is undefined for non-empty classes
        ...
        # IoU loss is defined to be 1 if there are 0 ground truth pixels
        # If the dataset contains empty segmentations, then IoU should
        # be used in conjunction with BCE
