...
class TverskyLoss(DiceLoss):
    ...
    def __init__(
        ...
        super().__init__(mode, classes, log_loss, from_logits, 1, smooth, ignore_index, eps)
        self.alpha = alpha
        self.beta = beta
        self.gamma = gamma
    ...
    def compute_score(self, output, target, exponent=1, smooth=0.0, eps=1e-7, dims=None) -> torch.Tensor:
